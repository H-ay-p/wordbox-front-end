...
const stringedLetters = letters.join("");
...
function validateInput(event) {
  ...
  const cleanedValue = Array.from(currentValue)
    .filter((char) => stringedLetters.includes(char))
    .join("");

  // Update the input value if invalid characters were found and removed
...
function preventInvalidInput(event) {
  if (!stringedLetters.includes(event.key)) {
